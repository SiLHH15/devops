pipeline {
    ...
    stages {
        ...
        stage('Packaging/Pushing imagae') {
            ...
            steps {
                withDockerRegistry(credentialsId: 'dockerhub', url: 'https://index.docker.io/v1/') {
                    ...
                    sh 'docker push knight1505/springboot'
                }
            }
        }
        ...
        stage('Deploy Spring Boot to DEV') {
            steps {
                echo 'Deploying and cleaning'
                sh 'docker image pull knight1505/springboot'
                sh 'docker container stop knight1505-springboot || echo "this container does not exist" '
                sh 'docker network create dev || echo "this network exists"'
                sh 'echo y | docker container prune '

                sh 'docker container run -d --rm --name knight1505-springboot -p 8081:8080 --network dev knight1505/springboot'
            }
        }
